...
public class Address {
    ...
    public String toString(){
        ...
        newPrint.append("Address{addressLine1='" +addressLine1 + "', addressLine2='" + addressLine2);
        newPrint.append("', city='" + city+ "', ");
        newPrint.append("state='" + state + "', ");
        newPrint.append("zipcode='" + zipcode + "'}");
